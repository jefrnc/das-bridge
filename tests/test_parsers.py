...
class TestDASResponseParser(unittest.TestCase):
    ...
    def test_parse_order_line(self):
        ...
        line = "%ORDER 52493 586 CIGL B L 5 0 0 2.97 ARCA Executed 09:53:27 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey"
        ...
        self.assertEqual(order.account, "YOUR_ACCOUNT")
        self.assertEqual(order.user, "YOUR_ACCOUNT")
    ...
    def test_parse_response_mixed(self):
        ...
        response = """
%ORDER 52493 586 CIGL B L 5 0 0 2.97 ARCA Executed 09:53:27 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%TRADE 34277 CIGL B 10 3.8 EDUPRO 09:03:38 33998 - 0.00 0.00
$SHORTINFO BBLG N 0 N 0 0 N N
%ORDER 41494 441 CIGL B L 5 0 0 3.97 EDUPRO Executed 09:34:26 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
...
%ORDER 41494 441 BBLG B L 5 0 0 3.97 EDUPRO Executed 09:34:26 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%TRADE 34277 CIGL B 10 3.8 EDUPRO 09:03:38 33998 - 0.00 0.00
...
"""
    ...
    def test_get_symbol_summary(self):
        ...
        response = """
%ORDER 52493 586 CIGL B L 5 0 0 2.97 ARCA Executed 09:53:27 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%ORDER 52494 587 CIGL B L 10 0 0 3.00 ARCA Executed 09:54:00 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%ORDER 52495 588 CIGL S L 5 0 5 3.10 ARCA Canceled 09:55:00 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%ORDER 52496 589 CIGL S L 5 0 0 3.05 ARCA Executed 09:56:00 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%TRADE 34277 CIGL B 10 3.8 EDUPRO 09:03:38 33998 - 0.00 0.00
"""
...
%ORDER 81375 794 BBLG SS L 5 0 0 2.88 ARCA Executed 13:00:40 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%ORDER 52493 586 CIGL B L 5 0 0 2.97 ARCA Executed 09:53:27 0 YOUR_ACCOUNT YOUR_ACCOUNT Hotkey
%TRADE 34277 CIGL B 10 3.8 EDUPRO 09:03:38 33998 - 0.00 0.00
$SHORTINFO BBLG N 0 N 0 0 N N
